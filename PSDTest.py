...
ax[0].text(5200, 11000, str(round(R[0][0][0],2)) + "\%")
ax[0].text(5500, 11000, str(round(R[0][1][0],2)) + "\%")
ax[0].text(5820, 5000, str(round(R[0][2][0],2)) + "\%")
...
ax[1].text(5200, 7000, str(round(R[1][0][0],2)) + "\%")
ax[1].text(5500, 12000, str(round(R[1][1][0],2)) + "\%")
ax[1].text(5820, 7000, str(round(R[1][2][0],2)) + "\%")
