...
plt.text(5200, 8000, str(round(fit.get("R[%]")[0,0],2)) + "(" + str(round(fit.get("R[%]")[0,1],2)) + ")" + "\%" )
plt.text(5520, 8000, str(round(fit.get("R[%]")[1,0],2)) + "(" + str(round(fit.get("R[%]")[1,1],2)) + ")" + "\%" )
plt.text(5840, 4000, str(round(fit.get("R[%]")[2,0],2)) + "(" + str(round(fit.get("R[%]")[2,1],2)) + ")" + "\%" )
plt.xlim(5000,6000)
plt.ylim(0)
